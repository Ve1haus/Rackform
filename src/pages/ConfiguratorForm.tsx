...
export default function ConfiguratorForm() {
  ...
  return (
    <div style={{ fontFamily: 'Inter, sans-serif', maxWidth: '620px', margin: '0 auto', padding: '4rem 1.5rem', color: '#222' }}>
      {stage === 'intro' && (
        <div className="step" style={{ textAlign: 'center' }}>
          <img src="/logo.png" alt="Rackform" style={{ width: 110, marginBottom: '2rem' }} />
          <h1 style={{ fontSize: '2.25rem', marginBottom: '1rem', fontWeight: 600 }}>
